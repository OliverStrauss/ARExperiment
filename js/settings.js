...
const KEY = 'sticky-wall.settings.v1';
...
export const SLIDERS = [
  ...
  { key: 'sMin', group: 'HSV threshold', label: 'Sat min', min: 0, max: 255, step: 1, def: 90 },
  ...
  { key: 'procWidth', group: 'Mask cleanup', label: 'Process width px', min: 320, max: 1280, step: 160, def: 640 },
  { key: 'minArea', group: 'Note filter', label: 'Min area % of frame', min: 0.01, max: 5, step: 0.01, def: 0.15 },
